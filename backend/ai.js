...
function getFallbackAssistantReply(msg, fileUrl = null, fileType = null) {
  ...
  // General facts
  const gkFacts = {
    "peacock": "The peacock is a large, colorful bird best known for its iridescent tail feathers.\n\nKey Facts:\n• National Bird: India designated the Indian Peacock as its national bird in 1963.\n• Symbolism: Revered in Hindu mythology, representing beauty, grace, and pride.\n• Males vs Females: Males (peacocks) display the bright train, while females (peahens) are brown and lack it.",
    "birds meaning": "Birds are warm-blooded, egg-laying vertebrate animals characterized by feathers, beaks, and wings.\n\nKey Features:\n• Feathers: The only living animals that possess feathers, used for flight and temperature control.\n• Adaptations: Light skeleton, hollow bones, and high-rate metabolism to facilitate flight.\n• Diversity: Over 10,000 living species ranging from tiny hummingbirds to large ostriches.",
    "michael jackson": "Michael Jackson (1958–2009) was an iconic American singer, songwriter, and dancer, widely known as the King of Pop.\n\nCareer Highlights:\n• Best-Selling Album: His 1982 album Thriller remains the best-selling album of all time worldwide.\n• Dance Innovations: Popularized complex dance techniques including the moonwalk and the robot.\n• Legacy: Recipient of 13 Grammy Awards and inducted into the Rock and Roll Hall of Fame twice.",
    "indian cricket team": "The Indian men's national cricket team represents India in international cricket.\n\nGoverning Body:\n• BCCI: Managed by the Board of Control for Cricket in India.\n\nWorld Cup Victories:\n• ODI World Cups: Won in 1983 (captained by Kapil Dev) and 2011 (captained by MS Dhoni).\n• T20 World Cups: Won in 2007 (captained by MS Dhoni) and 2024 (captained by Rohit Sharma).",
    "t20 world cup winner": "The T20 World Cup is the premier international championship in Twenty20 cricket.\n\nRecent Winners:\n• 2024 Champions: India won the tournament held in June 2024 by defeating South Africa in the final.\n• Most Titles: India, England, and West Indies have won the tournament twice each.\n• Next Edition: The next tournament will take place in 2026, hosted jointly by India and Sri Lanka.",
